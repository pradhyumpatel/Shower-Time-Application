...
# Run SQL command
sed -i "s/\$ACCESSFROMIP/$ACCESSFROMIP/g" ~/gprawdzik/sample-team-repo-structure/sprint-03/code/db-samples/create-user-with-permissions-sample.sql
sed -i "s/\$USERPASS/$USERPASS/g" ~/gprawdzik/sample-team-repo-structure/sprint-03/code/db-samples/create-user-with-permissions-sample.sql
...
sudo mysql -u root < ~/gprawdzik/sample-team-repo-structure/sprint-03/code/db-samples/create-user-with-permissions-sample.sql
